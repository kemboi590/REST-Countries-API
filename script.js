document.addEventListener("DOMContentLoaded", () => {
    ...
    function filterCountries() {
      ...
      allCountries.forEach((countryCard) => {
        const countryName = countryCard.querySelector(".country-name").innerText.toLowerCase();
        const countryRegion = countryCard.querySelector(".country-region").innerText.split(": ")[1].toLowerCase();
